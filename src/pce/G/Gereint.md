...
attributes:
  - Gereint assaulted by protector
  - maiden sitting within the court
  - protector fierce
  - knight fierce
  - Gereint proved himself
  - knight killed by Gereint
  - violent games ended forever
  - Gereint reconciled with Enid
  - Enid loyal wife of Gereint
categories:
  - location
  - person
entities:
...
```
![Gereint Image](['https://upload.wikimedia.org/wikipedia/commons/3/38/Sir_Geraint%2C_Son_of_Erbin.png'])
