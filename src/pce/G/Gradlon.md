...
attributes:
  - Gradlon model of the Celtic regional king
  - Gradlon made his land wealthy
  - Gradlon protected it by defeating the Vikings on the Loire river
  - his name said to have been borne by later kings of the region
categories:
  - geographic feature
  - region
  - invaders
  - Celtic regional king
entities:
  - Gradlon(Celtic regional king)
  - Brittany(region)
  - Vikings(invaders)
  - Loire river(geographic feature)
tags:
  - Gradlon
  - Brittany
  - Vikings
...
```
![Gradlon Image](['https://upload.wikimedia.org/wikipedia/commons/f/f4/Gradlon-statue-quimper.JPG'])
