...
attributes:
  - Tam Lin gave instructions to Janet
  - Janet followed Tam Lin's instructions
  - Samhain night night when Janet went out to watch the Wild Hunt pass on the road
  - milk-white steed animal ridden by Tam Lin
  - eel animal that Janet held
  - bear animal that Janet held
  - lion animal that Janet held
  - spike of fire object that Janet held
  - enchantment spell that Tam Lin was under
categories:
  - event
  - mythical creature
  - person
...
```
![Tam Lin Image](['https://upload.wikimedia.org/wikipedia/commons/5/52/Page_161_illustration_in_More_English_Fairy_Tales.png'])
