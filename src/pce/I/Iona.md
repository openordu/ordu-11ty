...
attributes:
  - well healing
  - Iona open to both men and women
  - women barred from residing on Iona
  - churches home to a pregnant, self-exposing female figure called a Sheela Na Gig
categories:
  - location
  - art
  - religion
...
```
![Iona Image](['https://upload.wikimedia.org/wikipedia/commons/0/0d/Iona_Abbey_from_water.jpg'])
